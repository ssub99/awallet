...
function removeAllLogsFromHome() {
  try {
...
// 메인 실행
console.log('🚀 홈 파일 모든 로그 제거 시작...\n');
removeAllLogsFromHome();
console.log('\n✅ 홈 파일 모든 로그 제거 완료!');
