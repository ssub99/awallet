...
// 이모지 카테고리 타입
export type EmojiCategory = 'recent' | 'people' | 'animals' | 'food' | 'activity' | 'travel' | 'objects' | 'symbols' | 'flags';
        ...
        <View style={[styles.content, { backgroundColor: palette.fill }]}>
          ...
          >
            ...
            <View style={styles.emojiSection}>
              ...
              >
                <CategoryEmojiText variant="medium">{selectedEmoji}</CategoryEmojiText>
              </Pressable>
            </View>
